      ...
      <div className="main-wrap">
        ...
        <aside>
          ...
          <div className="sidebar-box-green">
            ...
            <div className="sidebar-text"><a href={AUTHOR_URL} target="_blank" rel="noopener" style={{ color: '#7ec8a0', fontWeight: 600 }}>{AUTHOR_NAME}</a>, Michigan angler and founder of the Michigan Trout Report. Live data for 110+ rivers at <a href="https://michigantroutreport.com" target="_blank" rel="noopener">michigantroutreport.com</a>.</div>
          </div>
        </aside>
      </div>
    </>
