...
export const SITE_URL = 'https://michigantroutdaily.vercel.app';
...
export function siteSchema() {
  return {
    ...
    name: SITE_NAME,
    url: SITE_URL,
    description: "Daily Michigan trout stream conditions, hatch reports, and fly fishing intelligence. By Chris Izworski.",
    author: {
      '@type': 'Person',
      name: AUTHOR_NAME,
      url: AUTHOR_URL,
      sameAs: [AUTHOR_URL, 'https://trout.chrisizworski.com'],
    },
  };
}
